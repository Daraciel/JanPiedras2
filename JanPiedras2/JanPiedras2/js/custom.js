$(document).ready(function() {                  	
   ...
   //SHOWING MENU TOOLTIP ------ delete if you don't want it!                    
    ...
    $('#hide_menu a.menu_visible').live('click',function(){	
		    ...
		    $('#menu_wrap').animate({top: "-=520px"}, "normal", function() {      	
		                $('.menu_tooltip p').text('Mostrar el menu');	//tooltip text in when menu is 'hidden' 
	        });
	...
	//SHOWING MENU	
		//click on show menu button (arrow points down)                      	
		 $('#hide_menu a.menu_hidden').live('click', function(){	
			...
			// hide the tooltip      
		      $('.menu_tooltip').css('opacity', '0');    
		        $('#menu_wrap').animate({ top: "+=520px"}, 'normal');  
		            $('.menu_tooltip p').text('Esconder el menu'); //tooltip text in when menu is 'visible' 
